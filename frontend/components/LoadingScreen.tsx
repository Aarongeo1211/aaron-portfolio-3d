      ...
      <div className="text-center">
        <div className="relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="w-12 h-12 bg-gradient-to-r from-slate-600 to-slate-800 rounded-full flex items-center justify-center animate-pulse">
        ...
        <div className="mt-6">
          ...
          <p className="text-slate-600 mt-1 animate-pulse">Initializing AI Assistant...</p>
        </div>
      </div>
    </div>
  );
