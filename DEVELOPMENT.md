...
```bash
git remote add encore encore://aaron-portfolio-3d-h6g2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/aaron-portfolio-3d-h6g2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/aaron-portfolio-3d-h6g2/settings/integrations/github)
